var highScores = {'traditional':[['TL27',1000000,1,42],['BOB',125000,3,212],['MARIE',64000,0,468],['AMY',64000,2,227],['JAKE',32000,3,84]],
            'modern':[['ALICE',250000,2,130],['JAMES',150000,3,46],['SALLY',75000,2,141],['OLAF',75000,4,83],['TOM',1000,2,11]]},
...
function newHighScore() {
  ...
  else $('#message-text').html('New high score!<br/><br/>Enter your name:');
